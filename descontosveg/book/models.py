...
class Usual(models.Model):
    ...
    description = models.TextField(_('descricao'),max_length=1000,blank=True)
...
class Sale(Usual):
    ...
    rules = models.TextField(_('Regras de uso'),max_length=1000,blank=True)
...
class Partner(models.Model):
    ...
    address = models.CharField(_('Endereco'),max_length=300,null=True, blank=True)
